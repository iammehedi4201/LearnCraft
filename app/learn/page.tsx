        ...
        <div className="bg-slate-900 rounded-[3rem] p-12 sm:p-20 text-white relative overflow-hidden shadow-2xl">
          <div className="relative z-10 max-w-3xl">
            ...
            <div className="flex flex-wrap gap-4">
              <button className="bg-white dark:bg-slate-900/50 text-slate-900 px-8 py-4 rounded-full font-bold shadow-lg hover:bg-slate-100 transition-all flex items-center gap-3">
