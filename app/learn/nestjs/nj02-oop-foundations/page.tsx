    ...
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0f172a] text-slate-900 dark:text-slate-300 selection:bg-primary/30">
      ...
      <div className="relative z-10 max-w-[90rem] mx-auto px-6 lg:px-12 py-10">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-7 items-start justify-center">
          ...
          {/* Stepper Sidebar */}
          <aside className="lg:w-[260px] shrink-0 lg:sticky lg:top-32">
            <div className="py-2">
              ...
              <nav className="relative">
                ...
                <div
                  className="absolute left-[22px] top-[22px] w-[2px] bg-slate-200 dark:bg-slate-800 rounded-full"
              ...
              <div className="mt-4 flex gap-2">
                <button
                  onClick={() => currentIndex > 0 && handleSectionChange(SECTIONS[currentIndex - 1].id)}
                ...
                <button
                  onClick={() => currentIndex < SECTIONS.length - 1 && handleSectionChange(SECTIONS[currentIndex + 1].id)}
