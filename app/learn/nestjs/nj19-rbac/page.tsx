/**
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 * NJ-19 — RBAC & Role-Based Authorization
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 *
 * CORE CONCEPT
 * ────────────
 * Master authorization in NestJS: Role enums, @Roles() metadata,
 * RolesGuard implementation with Reflector, role hierarchies,
 * fine-grained permissions, and Attribute-Based Access Control (ABAC)
 * with CASL (@casl/ability).
 *
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 */
...
import { RolesEnumSection } from "./components/roles-enum-section";
import { RolesDecoratorSection } from "./components/roles-decorator-section";
import { RolesGuardSection } from "./components/roles-guard-section";
import { RoleHierarchySection } from "./components/role-hierarchy-section";
import { ClaimsPermissionsSection } from "./components/claims-permissions-section";
import { CaslOverviewSection } from "./components/casl-overview-section";
import { CaslAbilityFactorySection } from "./components/casl-ability-factory-section";
import { PoliciesGuardSection } from "./components/policies-guard-section";
...
const SECTIONS = [
  ...
  { id: "part2",  label: "Role Enums",                  icon: "🏷️" },
  { id: "part3",  label: "The @Roles() Decorator",      icon: "🔖" },
  { id: "part4",  label: "Building RolesGuard",         icon: "🚪" },
  { id: "part5",  label: "Role Hierarchy & Weights",    icon: "👑" },
  { id: "part6",  label: "Claims & Permissions",        icon: "🎯" },
  { id: "part7",  label: "CASL & ABAC Overview",        icon: "🛡️" },
  { id: "part8",  label: "CaslAbilityFactory Service",  icon: "🏭" },
  { id: "part9",  label: "PoliciesGuard & Evaluation",  icon: "📐" },
  { id: "part10", label: "Top 5 Beginner Mistakes",     icon: "⚠️" },
  { id: "part11", label: "Top 5 Interview Q&As",        icon: "💡" },
  { id: "part12", label: "Authorization Models Matrix", icon: "📊" },
  { id: "part13", label: "RBAC Coding Exercises",       icon: "💻" },
  { id: "part14", label: "Summary & Next Steps",        icon: "🎓" },
];

const PROGRESS_STORAGE_KEY = "learncraft_progress_nj19-rbac";

export default function NJ19Rbac(): JSX.Element {
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case "part2":  return <RolesEnumSection />;
      case "part3":  return <RolesDecoratorSection />;
      case "part4":  return <RolesGuardSection />;
      case "part5":  return <RoleHierarchySection />;
      case "part6":  return <ClaimsPermissionsSection />;
      case "part7":  return <CaslOverviewSection />;
      case "part8":  return <CaslAbilityFactorySection />;
      case "part9":  return <PoliciesGuardSection />;
