/**
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 * NJ-17 — Custom Decorators
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 *
 * CORE CONCEPT
 * ────────────
 * Understand how to create custom parameter decorators with
 * createParamDecorator(), compose multiple decorators with
 * applyDecorators(), build the famous @CurrentUser() decorator,
 * and define type-safe metadata with Reflector.createDecorator().
 *
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 */
...
import { ParamDecoratorsSection } from "./components/param-decorators-section";
import { CurrentUserSection } from "./components/current-user-section";
import { DecoratorDataArgsSection } from "./components/decorator-data-args-section";
import { ApplyDecoratorsSection } from "./components/apply-decorators-section";
import { AuthCompositeDecoratorSection } from "./components/auth-composite-decorator-section";
import { CustomHeadersSection } from "./components/custom-headers-section";
import { MetadataDecoratorsSection } from "./components/metadata-decorators-section";
import { PipesWithDecoratorsSection } from "./components/pipes-with-decorators-section";
...
const SECTIONS = [
  ...
  { id: "part2",  label: "createParamDecorator()",      icon: "⚙️" },
  { id: "part3",  label: "The @CurrentUser() Pattern",  icon: "👤" },
  { id: "part4",  label: "Passing Decorator Arguments", icon: "🎯" },
  { id: "part5",  label: "applyDecorators() Composition", icon: "📦" },
  { id: "part6",  label: "The Composite @Auth() Tag",   icon: "🛡️" },
  { id: "part7",  label: "Utility Param Decorators",    icon: "🛠️" },
  { id: "part8",  label: "Reflector.createDecorator",   icon: "🏷️" },
  { id: "part9",  label: "Pipes with Custom Decorators",icon: "🔍" },
  { id: "part10", label: "Top 5 Beginner Mistakes",     icon: "⚠️" },
  { id: "part11", label: "Top 5 Interview Q&As",        icon: "💡" },
  { id: "part12", label: "Decorator Creation Matrix",   icon: "📊" },
  { id: "part13", label: "Decorator Coding Practice",   icon: "💻" },
  { id: "part14", label: "Summary & Next Steps",        icon: "🎓" },
];

const PROGRESS_STORAGE_KEY = "learncraft_progress_nj17-custom-decorators";

export default function NJ17CustomDecorators(): JSX.Element {
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case "part2":  return <ParamDecoratorsSection />;
      case "part3":  return <CurrentUserSection />;
      case "part4":  return <DecoratorDataArgsSection />;
      case "part5":  return <ApplyDecoratorsSection />;
      case "part6":  return <AuthCompositeDecoratorSection />;
      case "part7":  return <CustomHeadersSection />;
      case "part8":  return <MetadataDecoratorsSection />;
      case "part9":  return <PipesWithDecoratorsSection />;
