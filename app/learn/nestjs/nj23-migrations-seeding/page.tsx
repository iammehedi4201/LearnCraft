/**
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 * NJ-23 — Migrations & Database Seeding
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 *
 * CORE CONCEPT
 * ────────────
 * Production database schema management with Prisma Migrate:
 * Local development (prisma migrate dev), production deployments
 * (prisma migrate deploy), schema drift resolution, _prisma_migrations
 * table, automated database seeding with prisma/seed.ts, and Prisma Studio.
 *
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 */
...
import { PrismaMigrateDevSection } from "./components/prisma-migrate-dev-section";
import { MigrationHistoryTableSection } from "./components/migration-history-table-section";
import { PrismaMigrateDeploySection } from "./components/prisma-migrate-deploy-section";
import { PrismaDbPushSection } from "./components/prisma-db-push-section";
import { SeedingDatabaseSection } from "./components/seeding-database-section";
import { RollbackTroubleshootingSection } from "./components/rollback-troubleshooting-section";
import { PrismaStudioSection } from "./components/prisma-studio-section";
import { SeedFactoriesFakerSection } from "./components/seed-factories-faker-section";
...
const SECTIONS = [
  ...
  { id: "part2",  label: "prisma migrate dev",          icon: "💻" },
  { id: "part3",  label: "Migration History Table",     icon: "📜" },
  { id: "part4",  label: "Production Deployments",      icon: "🚢" },
  { id: "part5",  label: "db push vs migrate",          icon: "⚖️" },
  { id: "part6",  label: "Database Seeding (seed.ts)",  icon: "🌱" },
  { id: "part7",  label: "Resolving Failed Migrations", icon: "🛠️" },
  { id: "part8",  label: "Prisma Studio Visual GUI",    icon: "🖥️" },
  { id: "part9",  label: "Mock Data with Faker",        icon: "🎭" },
  { id: "part10", label: "Top 5 Beginner Mistakes",     icon: "⚠️" },
  { id: "part11", label: "Top 5 Interview Q&As",        icon: "💡" },
  { id: "part12", label: "Prisma CLI Master Table",     icon: "📊" },
  { id: "part13", label: "Migration Coding Practice",   icon: "💻" },
  { id: "part14", label: "Summary & Next Steps",        icon: "🎓" },
];

const PROGRESS_STORAGE_KEY = "learncraft_progress_nj23-migrations-seeding";

export default function NJ23MigrationsSeeding(): JSX.Element {
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case "part2":  return <PrismaMigrateDevSection />;
      case "part3":  return <MigrationHistoryTableSection />;
      case "part4":  return <PrismaMigrateDeploySection />;
      case "part5":  return <PrismaDbPushSection />;
      case "part6":  return <SeedingDatabaseSection />;
      case "part7":  return <RollbackTroubleshootingSection />;
      case "part8":  return <PrismaStudioSection />;
      case "part9":  return <SeedFactoriesFakerSection />;
