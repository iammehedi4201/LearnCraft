    ...
    <div className="p-5 rounded-2xl bg-ds-bg-weak border border-ds-stroke-soft shadow-sm mb-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div>
          ...
          <EnhancedCodeBlock code={wrong} language="bash" />
        </div>
        <div>
          ...
          <EnhancedCodeBlock code={right} language="bash" />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="p-5 rounded-2xl bg-ds-bg-weak border border-ds-stroke-soft shadow-sm mb-6">
      <h4 className="font-bold text-xs uppercase tracking-wider text-ds-feature-dark mb-2 flex items-center gap-2">
        <span>🧩</span> Predict Migration Command Behavior
      </h4>
      <p className="text-xs text-ds-text-sub mb-3">
        Analyze the schema change and CLI command below. What will happen to the database?
      </p>
      <EnhancedCodeBlock code={code} language="bash" />
      <button
      ...
      >
        {show ? "Hide Answer" : "Reveal Migration Outcome"}
      </button>
      {show && (
