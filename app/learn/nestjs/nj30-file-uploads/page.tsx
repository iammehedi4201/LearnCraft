/**
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 * NJ-30 — File Uploads & AWS S3
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 *
 * CORE CONCEPT
 * ────────────
 * Production file upload and cloud storage architecture in NestJS:
 * Multer FileInterceptor & FilesInterceptor, ParseFilePipeBuilder validation,
 * AWS SDK v3 S3Client, streaming PutObjectCommand uploads, direct-to-S3
 * Pre-Signed upload URLs, Sharp image compression, and private CDN URLs.
 *
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 */
...
import { MulterFileInterceptorSection } from "./components/multer-file-interceptor-section";
import { MultipleFilesUploadSection } from "./components/multiple-files-upload-section";
import { FileValidationPipesSection } from "./components/file-validation-pipes-section";
import { AwsS3ClientSetupSection } from "./components/aws-s3-client-setup-section";
import { StreamingUploadToS3Section } from "./components/streaming-upload-to-s3-section";
import { PresignedUrlsDirectUploadSection } from "./components/presigned-urls-direct-upload-section";
import { ImageResizingSharpSection } from "./components/image-resizing-sharp-section";
import { ServingPrivateFilesCdnSection } from "./components/serving-private-files-cdn-section";
...
const SECTIONS = [
  ...
  { id: "part2",  label: "Multer & FileInterceptor",    icon: "📎" },
  { id: "part3",  label: "Multi-File Uploads",          icon: "📚" },
  { id: "part4",  label: "ParseFilePipe Validation",    icon: "🛡️" },
  { id: "part5",  label: "AWS S3 SDK v3 Client",        icon: "☁️" },
  { id: "part6",  label: "Direct Buffer S3 Upload",     icon: "📦" },
  { id: "part7",  label: "Pre-Signed Direct URLs",      icon: "⚡" },
  { id: "part8",  label: "Sharp Image Optimization",    icon: "🖼️" },
  { id: "part9",  label: "Serving Private Files & CDN", icon: "🔒" },
  { id: "part10", label: "Top 5 Beginner Mistakes",     icon: "⚠️" },
  { id: "part11", label: "Top 5 Interview Q&As",        icon: "💡" },
  { id: "part12", label: "Storage Strategy Matrix",     icon: "📊" },
  { id: "part13", label: "Upload Coding Practice",      icon: "💻" },
  { id: "part14", label: "Summary & Next Steps",        icon: "🎓" },
];

const PROGRESS_STORAGE_KEY = "learncraft_progress_nj30-file-uploads";

export default function NJ30FileUploads(): JSX.Element {
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case "part2":  return <MulterFileInterceptorSection />;
      case "part3":  return <MultipleFilesUploadSection />;
      case "part4":  return <FileValidationPipesSection />;
      case "part5":  return <AwsS3ClientSetupSection />;
      case "part6":  return <StreamingUploadToS3Section />;
      case "part7":  return <PresignedUrlsDirectUploadSection />;
      case "part8":  return <ImageResizingSharpSection />;
      case "part9":  return <ServingPrivateFilesCdnSection />;
