/**
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 * NJ-27 — Structured Logging with Pino
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 *
 * CORE CONCEPT
 * ────────────
 * Production observability and high-speed logging in NestJS:
 * nestjs-pino, JSON log output, correlation IDs (X-Request-Id),
 * automated HTTP request access logs, sensitive field redaction
 * (GDPR/PCI), log levels, and local vs production transports.
 *
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 */
...
import { WhyPinoVsConsoleSection } from "./components/why-pino-vs-console-section";
import { NestjsPinoSetupSection } from "./components/nestjs-pino-setup-section";
import { CorrelationRequestIdsSection } from "./components/correlation-request-ids-section";
import { RedactingSensitiveLogsSection } from "./components/redacting-sensitive-logs-section";
import { InjectingPinoLoggerSection } from "./components/injecting-pino-logger-section";
import { CustomLogLevelsSection } from "./components/custom-log-levels-section";
import { PinoPrettyTransportsSection } from "./components/pino-pretty-transports-section";
import { HttpAccessLoggingSection } from "./components/http-access-logging-section";
...
const SECTIONS = [
  ...
  { id: "part2",  label: "Why Pino vs console.log",     icon: "⚖️" },
  { id: "part3",  label: "Installing nestjs-pino",      icon: "⚙️" },
  { id: "part4",  label: "Correlation IDs (Tracing)",   icon: "🆔" },
  { id: "part5",  label: "Log Redaction & Secrets",     icon: "🔒" },
  { id: "part6",  label: "Injecting PinoLogger",        icon: "📦" },
  { id: "part7",  label: "Log Levels & Filtering",      icon: "📶" },
  { id: "part8",  label: "pino-pretty vs Cloud JSON",   icon: "🎨" },
  { id: "part9",  label: "HTTP Access Logging",         icon: "⚡" },
  { id: "part10", label: "Top 5 Beginner Mistakes",     icon: "⚠️" },
  { id: "part11", label: "Top 5 Interview Q&As",        icon: "💡" },
  { id: "part12", label: "Logging Benchmark Matrix",    icon: "📊" },
  { id: "part13", label: "Logging Coding Practice",     icon: "💻" },
  { id: "part14", label: "Summary & Next Steps",        icon: "🎓" },
];

const PROGRESS_STORAGE_KEY = "learncraft_progress_nj27-logging";

export default function NJ27Logging(): JSX.Element {
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case "part2":  return <WhyPinoVsConsoleSection />;
      case "part3":  return <NestjsPinoSetupSection />;
      case "part4":  return <CorrelationRequestIdsSection />;
      case "part5":  return <RedactingSensitiveLogsSection />;
      case "part6":  return <InjectingPinoLoggerSection />;
      case "part7":  return <CustomLogLevelsSection />;
      case "part8":  return <PinoPrettyTransportsSection />;
      case "part9":  return <HttpAccessLoggingSection />;
