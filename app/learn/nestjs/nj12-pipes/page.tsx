/**
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 * NJ-12 — Pipes & Transformation
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 *
 * CORE CONCEPT
 * ────────────
 * Understand how to transform and validate incoming parameter data using
 * NestJS built-in pipes (ParseIntPipe, ParseBoolPipe, ValidationPipe)
 * and custom PipeTransform implementations.
 *
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 */
...
import { BuiltinPipesSection } from "./components/builtin-pipes-section";
import { CustomTransformationSection } from "./components/custom-transformation-section";
import { CustomValidationSection } from "./components/custom-validation-section";
import { PipeScopesSection } from "./components/pipe-scopes-section";
import { DefaultValuePipeSection } from "./components/default-value-pipe-section";
import { ParseArrayPipeSection } from "./components/parse-array-pipe-section";
import { ParseFilePipeSection } from "./components/parse-file-pipe-section";
import { PipeCompositionSection } from "./components/pipe-composition-section";
...
const SECTIONS = [
  ...
  { id: "part2",  label: "The 9 Built-in Pipes",        icon: "📦" },
  { id: "part3",  label: "Custom Transformation Pipes", icon: "⚙️" },
  { id: "part4",  label: "Custom Validation Pipes",     icon: "🛡️" },
  { id: "part5",  label: "The 4 Pipe Scopes",           icon: "📐" },
  { id: "part6",  label: "DefaultValuePipe (Optional)", icon: "⚡" },
  { id: "part7",  label: "ParseArrayPipe (Bulk Data)",  icon: "📋" },
  { id: "part8",  label: "ParseFilePipe (Uploads)",     icon: "📁" },
  { id: "part9",  label: "Pipe Composition & Chaining", icon: "🔗" },
  { id: "part10", label: "Top 5 Beginner Mistakes",     icon: "⚠️" },
  { id: "part11", label: "Top 5 Interview Q&As",        icon: "💡" },
  { id: "part12", label: "Built-in Pipes Cheat Sheet",  icon: "📊" },
  { id: "part13", label: "Pipe Coding Exercises",       icon: "💻" },
  { id: "part14", label: "Summary & Next Steps",        icon: "🎓" },
];

const PROGRESS_STORAGE_KEY = "learncraft_progress_nj12-pipes";

export default function NJ12Pipes(): JSX.Element {
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case "part2":  return <BuiltinPipesSection />;
      case "part3":  return <CustomTransformationSection />;
      case "part4":  return <CustomValidationSection />;
      case "part5":  return <PipeScopesSection />;
      case "part6":  return <DefaultValuePipeSection />;
      case "part7":  return <ParseArrayPipeSection />;
      case "part8":  return <ParseFilePipeSection />;
      case "part9":  return <PipeCompositionSection />;
