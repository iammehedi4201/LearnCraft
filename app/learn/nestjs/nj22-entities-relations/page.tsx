/**
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 * NJ-22 — Entities, Relations & Schema Modeling
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 *
 * CORE CONCEPT
 * ────────────
 * Relational data modeling in Prisma ORM: 1-to-1 relations,
 * 1-to-Many relations, implicit & explicit Many-to-Many join tables,
 * cascade deletes (onDelete: Cascade), nested writes (create, connect),
 * compound indexes, and PostgreSQL native enums.
 *
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 */
...
import { OneToOneSection } from "./components/one-to-one-section";
import { OneToManySection } from "./components/one-to-many-section";
import { ManyToManyImplicitSection } from "./components/many-to-many-implicit-section";
import { ManyToManyExplicitSection } from "./components/many-to-many-explicit-section";
import { ReferentialActionsSection } from "./components/referential-actions-section";
import { NestedWritesSection } from "./components/nested-writes-section";
import { CompositeKeysIndexesSection } from "./components/composite-keys-indexes-section";
import { EnumsInPrismaSection } from "./components/enums-in-prisma-section";
...
const SECTIONS = [
  ...
  { id: "part2",  label: "1-to-1 Relations",            icon: "👤" },
  { id: "part3",  label: "1-to-Many Relations",         icon: "📝" },
  { id: "part4",  label: "Implicit Many-to-Many",       icon: "🏷️" },
  { id: "part5",  label: "Explicit Join Models",        icon: "📊" },
  { id: "part6",  label: "Cascade Deletes & Actions",   icon: "🗑️" },
  { id: "part7",  label: "Nested Writes (connect)",     icon: "✨" },
  { id: "part8",  label: "Composite Keys & Indexes",    icon: "⚡" },
  { id: "part9",  label: "Native Enums in Schema",      icon: "🎯" },
  { id: "part10", label: "Top 5 Beginner Mistakes",     icon: "⚠️" },
  { id: "part11", label: "Top 5 Interview Q&As",        icon: "💡" },
  { id: "part12", label: "Relations Master Matrix",     icon: "📊" },
  { id: "part13", label: "Relational Coding Practice",  icon: "💻" },
...
export default function NJ22EntitiesRelations(): JSX.Element {
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case "part2":  return <OneToOneSection />;
      case "part3":  return <OneToManySection />;
      case "part4":  return <ManyToManyImplicitSection />;
      case "part5":  return <ManyToManyExplicitSection />;
      case "part6":  return <ReferentialActionsSection />;
      case "part7":  return <NestedWritesSection />;
      case "part8":  return <CompositeKeysIndexesSection />;
      case "part9":  return <EnumsInPrismaSection />;
