    ...
    <div className="p-5 rounded-2xl bg-ds-bg-weak border border-ds-stroke-soft shadow-sm mb-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div>
          ...
          <EnhancedCodeBlock code={wrong} language="prisma" />
        </div>
        <div>
          ...
          <EnhancedCodeBlock code={right} language="prisma" />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="p-5 rounded-2xl bg-ds-bg-weak border border-ds-stroke-soft shadow-sm mb-6">
      <h4 className="font-bold text-xs uppercase tracking-wider text-ds-feature-dark mb-2 flex items-center gap-2">
        <span>🧩</span> Predict Database Query Output
      </h4>
      <p className="text-xs text-ds-text-sub mb-3">
        Analyze the relational Prisma query below. What structure will the returned JSON object have?
      </p>
      ...
      >
        {show ? "Hide Answer" : "Reveal Query Result"}
      </button>
      {show && (
