/**
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 * NJ-24 — Pagination, Filtering & Sorting
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 *
 * CORE CONCEPT
 * ────────────
 * Building scalable query APIs with NestJS & Prisma:
 * Offset-based pagination (skip & take), cursor-based pagination
 * for infinite scrolling feeds, performance benchmarks on 10M rows,
 * type-safe PaginationQueryDto with @Type(() => Number),
 * dynamic where clauses (AND, OR, contains, mode: 'insensitive'),
 * whitelist-validated sorting, and reusable pagination utilities.
 *
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 */
...
import { OffsetPaginationSection } from "./components/offset-pagination-section";
import { CursorPaginationSection } from "./components/cursor-pagination-section";
import { OffsetVsCursorSection } from "./components/offset-vs-cursor-section";
import { PaginationDtoSection } from "./components/pagination-dto-section";
import { PaginatedResponseMetaSection } from "./components/paginated-response-meta-section";
import { DynamicFilteringSection } from "./components/dynamic-filtering-section";
import { DynamicSortingSection } from "./components/dynamic-sorting-section";
import { ReusableQueryBuilderSection } from "./components/reusable-query-builder-section";
...
const SECTIONS = [
  ...
  { id: "part2",  label: "Offset Pagination (skip/take)", icon: "📄" },
  { id: "part3",  label: "Cursor Pagination (infinite)", icon: "🔖" },
  { id: "part4",  label: "Offset vs Cursor Benchmarks", icon: "📊" },
  { id: "part5",  label: "Pagination DTOs & Validation", icon: "📦" },
  { id: "part6",  label: "Standard Response Envelope",  icon: "📬" },
  { id: "part7",  label: "Dynamic Where Filtering",     icon: "🔍" },
  { id: "part8",  label: "Safe Dynamic Sorting",        icon: "📶" },
  { id: "part9",  label: "Reusable paginate() Utility", icon: "🛠️" },
  { id: "part10", label: "Top 5 Beginner Mistakes",     icon: "⚠️" },
  { id: "part11", label: "Top 5 Interview Q&As",        icon: "💡" },
  { id: "part12", label: "Query Operators Reference",   icon: "📑" },
  { id: "part13", label: "Pagination Coding Practice",  icon: "💻" },
  { id: "part14", label: "Summary & Next Steps",        icon: "🎓" },
];

const PROGRESS_STORAGE_KEY = "learncraft_progress_nj24-pagination-filtering";

export default function NJ24PaginationFiltering(): JSX.Element {
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case "part2":  return <OffsetPaginationSection />;
      case "part3":  return <CursorPaginationSection />;
      case "part4":  return <OffsetVsCursorSection />;
      case "part5":  return <PaginationDtoSection />;
      case "part6":  return <PaginatedResponseMetaSection />;
      case "part7":  return <DynamicFilteringSection />;
      case "part8":  return <DynamicSortingSection />;
      case "part9":  return <ReusableQueryBuilderSection />;
