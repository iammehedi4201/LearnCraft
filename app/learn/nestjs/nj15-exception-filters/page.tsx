/**
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 * NJ-15 — Exception Filters
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 *
 * CORE CONCEPT
 * ────────────
 * Centralized exception handling layer in NestJS: HttpException
 * hierarchy, custom domain exceptions, @Catch() all-exceptions
 * filters, ArgumentsHost, and enterprise JSON error response schemas.
 *
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 */
...
import { BuiltinExceptionsSection } from "./components/builtin-exceptions-section";
import { CustomExceptionsSection } from "./components/custom-exceptions-section";
import { ExceptionFilterAnatomySection } from "./components/exception-filter-anatomy-section";
import { AllExceptionsFilterSection } from "./components/all-exceptions-filter-section";
import { FilterScopesSection } from "./components/filter-scopes-section";
import { StructuredErrorSchemaSection } from "./components/structured-error-schema-section";
import { HttpAdapterHostSection } from "./components/http-adapter-host-section";
import { FilterExecutionOrderSection } from "./components/filter-execution-order-section";
...
const SECTIONS = [
  ...
  { id: "part2",  label: "Built-in HttpExceptions",     icon: "📦" },
  { id: "part3",  label: "Custom Domain Exceptions",    icon: "🏛️" },
  { id: "part4",  label: "ExceptionFilter Anatomy",     icon: "🩺" },
  { id: "part5",  label: "Global Catch-All Filter",     icon: "🛡️" },
  { id: "part6",  label: "The 3 Filter Scopes",         icon: "📐" },
  { id: "part7",  label: "Enterprise Error Schema",     icon: "📋" },
  { id: "part8",  label: "Universal HttpAdapterHost",   icon: "🔌" },
  { id: "part9",  label: "Filter Hierarchy & Priority", icon: "🧅" },
  { id: "part10", label: "Top 5 Beginner Mistakes",     icon: "⚠️" },
  { id: "part11", label: "Top 5 Interview Q&As",        icon: "💡" },
  { id: "part12", label: "HttpExceptions Master Matrix",icon: "📊" },
  { id: "part13", label: "Error Formatting Exercises",  icon: "💻" },
  { id: "part14", label: "Summary & Next Steps",        icon: "🎓" },
];

const PROGRESS_STORAGE_KEY = "learncraft_progress_nj15-exception-filters";

export default function NJ15ExceptionFilters(): JSX.Element {
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case "part2":  return <BuiltinExceptionsSection />;
      case "part3":  return <CustomExceptionsSection />;
      case "part4":  return <ExceptionFilterAnatomySection />;
      case "part5":  return <AllExceptionsFilterSection />;
      case "part6":  return <FilterScopesSection />;
      case "part7":  return <StructuredErrorSchemaSection />;
      case "part8":  return <HttpAdapterHostSection />;
      case "part9":  return <FilterExecutionOrderSection />;
