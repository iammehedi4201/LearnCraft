  ...
  return (
    <div className="p-5 rounded-2xl bg-ds-bg-weak border border-ds-stroke-soft shadow-sm mb-6">
      <h4 className="font-bold text-xs uppercase tracking-wider text-ds-feature-dark mb-2 flex items-center gap-2">
        <span>🧩</span> Predict Generated TypeScript Type
      </h4>
      <p className="text-xs text-ds-text-sub mb-3">
        Analyze the Prisma schema model below. What TypeScript type does `prisma generate` create?
      </p>
      <EnhancedCodeBlock code={code} language="prisma" />
      <button
      ...
      >
        {show ? "Hide Answer" : "Reveal Generated Type"}
      </button>
      {show && (
