/**
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 * NJ-21 — Database Setup (Prisma + PostgreSQL)
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 *
 * CORE CONCEPT
 * ────────────
 * Integrate Prisma ORM with NestJS: schema.prisma modeling,
 * PrismaService with OnModuleInit & OnModuleDestroy hooks,
 * global PrismaModule dependency injection, prisma generate
 * type creation, and SQL query logging.
 *
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 */
...
import { WhyPrismaSection } from "./components/why-prisma-section";
import { PrismaCliInstallSection } from "./components/prisma-cli-install-section";
import { SchemaAnatomySection } from "./components/schema-anatomy-section";
import { PrismaServiceSection } from "./components/prisma-service-section";
import { PrismaModuleSection } from "./components/prisma-module-section";
import { PrismaClientGenerationSection } from "./components/prisma-client-generation-section";
import { QueryLoggingSection } from "./components/query-logging-section";
import { ConnectionPoolingSection } from "./components/connection-pooling-section";
...
const SECTIONS = [
  ...
  { id: "part2",  label: "Why Prisma over TypeORM",     icon: "⚖️" },
  { id: "part3",  label: "Installing & Initializing",   icon: "💻" },
  { id: "part4",  label: "schema.prisma Anatomy",       icon: "📐" },
  { id: "part5",  label: "The PrismaService Class",     icon: "🔌" },
  { id: "part6",  label: "Global PrismaModule",         icon: "🌐" },
  { id: "part7",  label: "prisma generate & Types",     icon: "✨" },
  { id: "part8",  label: "SQL Query Logging",           icon: "🔍" },
  { id: "part9",  label: "Connection Pools & URLs",     icon: "🗄️" },
  { id: "part10", label: "Top 5 Beginner Mistakes",     icon: "⚠️" },
  { id: "part11", label: "Top 5 Interview Q&As",        icon: "💡" },
  { id: "part12", label: "ORM Feature Matrix",          icon: "📊" },
  { id: "part13", label: "Prisma Coding Exercises",     icon: "💻" },
  { id: "part14", label: "Summary & Next Steps",        icon: "🎓" },
];

const PROGRESS_STORAGE_KEY = "learncraft_progress_nj21-database-prisma";

export default function NJ21DatabasePrisma(): JSX.Element {
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case "part2":  return <WhyPrismaSection />;
      case "part3":  return <PrismaCliInstallSection />;
      case "part4":  return <SchemaAnatomySection />;
      case "part5":  return <PrismaServiceSection />;
      case "part6":  return <PrismaModuleSection />;
      case "part7":  return <PrismaClientGenerationSection />;
      case "part8":  return <QueryLoggingSection />;
      case "part9":  return <ConnectionPoolingSection />;
