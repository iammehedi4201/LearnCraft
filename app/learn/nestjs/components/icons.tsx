...
export function Circle({ className = "w-4 h-4", ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function Target({ className = "w-4 h-4", ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function BookmarkCheck({ className = "w-4 h-4", ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function LayoutGrid({ className = "w-4 h-4", ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function Scale({ className = "w-4 h-4", ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function Rocket({ className = "w-4 h-4", ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function Server({ className = "w-4 h-4", ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function Code2({ className = "w-4 h-4", ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function Flag({ className = "w-4 h-4", ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
