    ...
    <div className="p-5 rounded-2xl bg-ds-bg-weak border border-ds-stroke-soft shadow-sm mb-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div>
          ...
          <EnhancedCodeBlock code={wrong} language="dockerfile" />
        </div>
        <div>
          ...
          <EnhancedCodeBlock code={right} language="dockerfile" />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="p-5 rounded-2xl bg-ds-bg-weak border border-ds-stroke-soft shadow-sm mb-6">
      ...
      <p className="text-xs text-ds-text-sub mb-3">
        Compare single-stage build vs 3-stage multi-stage build. What is the final image size reduction?
      </p>
      <EnhancedCodeBlock code={code} language="dockerfile" />
      <button
      ...
      >
        {show ? "Hide Answer" : "Reveal Image Size"}
      </button>
      {show && (
