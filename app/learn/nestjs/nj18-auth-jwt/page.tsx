/**
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 * NJ-18 — Authentication (JWT & Passport)
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 *
 * CORE CONCEPT
 * ────────────
 * Build a complete production authentication flow in NestJS:
 * Password hashing with bcrypt, Passport LocalStrategy, Passport
 * JwtStrategy, JwtModule token signing, dual token architecture
 * (Access & Refresh), and route protection with JwtAuthGuard.
 *
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 */
...
import { AuthArchitectureSection } from "./components/auth-architecture-section";
import { PasswordHashingSection } from "./components/password-hashing-section";
import { LocalStrategySection } from "./components/local-strategy-section";
import { JwtStrategySection } from "./components/jwt-strategy-section";
import { TokenGenerationSection } from "./components/token-generation-section";
import { RefreshTokenSection } from "./components/refresh-token-section";
import { LoginRegisterFlowSection } from "./components/login-register-flow-section";
import { ProtectingRoutesSection } from "./components/protecting-routes-section";
...
const SECTIONS = [
  ...
  { id: "part2",  label: "The 3 Module Pillars",        icon: "🏛️" },
  { id: "part3",  label: "Password Hashing (bcrypt)",   icon: "🔒" },
  { id: "part4",  label: "Passport LocalStrategy",      icon: "🛂" },
  { id: "part5",  label: "Passport JwtStrategy",        icon: "🛡️" },
  { id: "part6",  label: "Signing Tokens (JwtService)", icon: "🔏" },
  { id: "part7",  label: "Dual Token Architecture",     icon: "🔄" },
  { id: "part8",  label: "Login & Register Controller", icon: "🌐" },
  { id: "part9",  label: "Protecting with JwtAuthGuard",icon: "🔑" },
  { id: "part10", label: "Top 5 Beginner Mistakes",     icon: "⚠️" },
  { id: "part11", label: "Top 5 Interview Q&As",        icon: "💡" },
  { id: "part12", label: "Auth Strategies Matrix",      icon: "📊" },
  { id: "part13", label: "JWT Claims Coding Exercises", icon: "💻" },
  { id: "part14", label: "Summary & Next Steps",        icon: "🎓" },
];

const PROGRESS_STORAGE_KEY = "learncraft_progress_nj18-auth-jwt";

export default function NJ18AuthJwt(): JSX.Element {
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case "part2":  return <AuthArchitectureSection />;
      case "part3":  return <PasswordHashingSection />;
      case "part4":  return <LocalStrategySection />;
      case "part5":  return <JwtStrategySection />;
      case "part6":  return <TokenGenerationSection />;
      case "part7":  return <RefreshTokenSection />;
      case "part8":  return <LoginRegisterFlowSection />;
      case "part9":  return <ProtectingRoutesSection />;
