/**
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 * NJ-13 — Guards & Authorization
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 *
 * CORE CONCEPT
 * ────────────
 * Understand authentication and authorization guards in NestJS:
 * CanActivate, ExecutionContext, Reflector metadata, Role-Based
 * Access Control (RBAC), and the @Public() route bypass strategy.
 *
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 */
...
import { CanActivateSection } from "./components/can-activate-section";
import { ExecutionContextSection } from "./components/execution-context-section";
import { AuthGuardSection } from "./components/auth-guard-section";
import { ReflectorMetadataSection } from "./components/reflector-metadata-section";
import { RolesGuardSection } from "./components/roles-guard-section";
import { PublicDecoratorSection } from "./components/public-decorator-section";
import { GuardScopesSection } from "./components/guard-scopes-section";
import { GuardChainingSection } from "./components/guard-chaining-section";
...
const SECTIONS = [
  ...
  { id: "part2",  label: "CanActivate Interface",       icon: "⚖️" },
  { id: "part3",  label: "ExecutionContext & Scope",    icon: "🔍" },
  { id: "part4",  label: "Building an AuthGuard",       icon: "🔑" },
  { id: "part5",  label: "Reflector & Metadata",        icon: "🏷️" },
  { id: "part6",  label: "Role-Based Access Control",   icon: "🛡️" },
  { id: "part7",  label: "The @Public() Bypass",        icon: "🔓" },
  { id: "part8",  label: "The 3 Guard Scopes",          icon: "📐" },
  { id: "part9",  label: "Guard Chaining & Short-Circuit", icon: "🔗" },
  { id: "part10", label: "Top 5 Beginner Mistakes",     icon: "⚠️" },
  { id: "part11", label: "Top 5 Interview Q&As",        icon: "💡" },
  { id: "part12", label: "Guards Master Matrix",        icon: "📊" },
  { id: "part13", label: "RBAC Coding Exercises",       icon: "💻" },
  { id: "part14", label: "Summary & Next Steps",        icon: "🎓" },
];

const PROGRESS_STORAGE_KEY = "learncraft_progress_nj13-guards";
...
export default function NJ13Guards(): JSX.Element {
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case "part2":  return <CanActivateSection />;
      case "part3":  return <ExecutionContextSection />;
      case "part4":  return <AuthGuardSection />;
      case "part5":  return <ReflectorMetadataSection />;
      case "part6":  return <RolesGuardSection />;
      case "part7":  return <PublicDecoratorSection />;
      case "part8":  return <GuardScopesSection />;
      case "part9":  return <GuardChainingSection />;
