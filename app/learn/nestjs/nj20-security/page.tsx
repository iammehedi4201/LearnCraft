/**
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 * NJ-20 — Security Hardening (Helmet, CORS, Throttler)
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 *
 * CORE CONCEPT
 * ────────────
 * Production security hardening in NestJS: Helmet HTTP response
 * headers, production CORS whitelisting, rate-limiting & DDoS
 * defense with @nestjs/throttler, XSS payload sanitization,
 * Mass Assignment protection, and OWASP Top 10 countermeasures.
 *
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 */
...
import { HelmetHeadersSection } from "./components/helmet-headers-section";
import { CorsWhitelistingSection } from "./components/cors-whitelisting-section";
import { RateLimitingThrottlerSection } from "./components/rate-limiting-throttler-section";
import { ThrottlerGuardSection } from "./components/throttler-guard-section";
import { PayloadSanitizationSection } from "./components/payload-sanitization-section";
import { CsrfProtectionSection } from "./components/csrf-protection-section";
import { SqlNosqlInjectionSection } from "./components/sql-nosql-injection-section";
import { SecurityChecklistSection } from "./components/security-checklist-section";
...
const SECTIONS = [
  ...
  { id: "part2",  label: "Helmet Security Headers",     icon: "🛡️" },
  { id: "part3",  label: "CORS Whitelisting",           icon: "🌐" },
  { id: "part4",  label: "Rate-Limiting (Throttler)",   icon: "⏱️" },
  { id: "part5",  label: "@Throttle & @SkipThrottle",   icon: "🎯" },
  { id: "part6",  label: "Payload Sanitization & XSS",  icon: "🧼" },
  { id: "part7",  label: "CSRF & SameSite Cookies",     icon: "🍪" },
  { id: "part8",  label: "SQL Injection & Prisma",      icon: "🔒" },
  { id: "part9",  label: "10-Step Security Checklist",  icon: "📋" },
  { id: "part10", label: "Top 5 Beginner Mistakes",     icon: "⚠️" },
  { id: "part11", label: "Top 5 Interview Q&As",        icon: "💡" },
  { id: "part12", label: "OWASP Top 10 Matrix",         icon: "📊" },
  { id: "part13", label: "Security Coding Exercises",   icon: "💻" },
  { id: "part14", label: "Phase 04 Grand Finale",       icon: "🎓" },
];

const PROGRESS_STORAGE_KEY = "learncraft_progress_nj20-security";

export default function NJ20Security(): JSX.Element {
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case "part2":  return <HelmetHeadersSection />;
      case "part3":  return <CorsWhitelistingSection />;
      case "part4":  return <RateLimitingThrottlerSection />;
      case "part5":  return <ThrottlerGuardSection />;
      case "part6":  return <PayloadSanitizationSection />;
      case "part7":  return <CsrfProtectionSection />;
      case "part8":  return <SqlNosqlInjectionSection />;
      case "part9":  return <SecurityChecklistSection />;
