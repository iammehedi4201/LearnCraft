 ...
 * CORE CONCEPT
 * ────────────
 * Dependency Injection is an inversion of control (IoC) technique wherein
 * you delegate instantiation of dependencies to the IoC container (in our
 * case, the NestJS runtime system).
 *
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 */
...
import { IocContainerSection } from "./components/ioc-container-section";
import { ConstructorInjectionSection } from "./components/constructor-injection-section";
import { PropertyInjectionSection } from "./components/property-injection-section";
import { CustomTokensSection } from "./components/custom-tokens-section";
import { FactoryProvidersSection } from "./components/factory-providers-section";
import { ValueProvidersSection } from "./components/value-providers-section";
import { ClassProvidersSection } from "./components/class-providers-section";
import { OptionalDependenciesSection } from "./components/optional-dependencies-section";
...
const SECTIONS = [
  ...
  { id: "part2",  label: "The IoC Container",        icon: "🧠" },
  { id: "part3",  label: "Constructor Injection",    icon: "🔌" },
  { id: "part4",  label: "Property Injection",       icon: "🏷️" },
  { id: "part5",  label: "Custom Injection Tokens",  icon: "🔑" },
  { id: "part6",  label: "Factory Providers",        icon: "⚙️" },
  { id: "part7",  label: "Value Providers (useValue)", icon: "🧪" },
  { id: "part8",  label: "Class Providers & Aliases", icon: "🔗" },
  { id: "part9",  label: "Optional Dependencies",    icon: "🛡️" },
  { id: "part10", label: "Beginner DI Mistakes",     icon: "⚠️" },
...
const PROGRESS_STORAGE_KEY = "learncraft_progress_nj09-dependency-injection";

export default function NJ09DependencyInjection(): JSX.Element {
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case "part2":  return <IocContainerSection />;
      case "part3":  return <ConstructorInjectionSection />;
      case "part4":  return <PropertyInjectionSection />;
      case "part5":  return <CustomTokensSection />;
      case "part6":  return <FactoryProvidersSection />;
      case "part7":  return <ValueProvidersSection />;
      case "part8":  return <ClassProvidersSection />;
      case "part9":  return <OptionalDependenciesSection />;
