...
export function SectionContainer({
  ...
  return (
    <section data-section-title={title} className="animate-in fade-in slide-in-from-bottom-6 duration-700">
  ...
  return (
    <div className="mb-6 p-5 rounded-2xl border border-ds-stroke-soft bg-ds-bg-weak shadow-sm" data-improve-block="predict-output">
      <div className="flex items-center gap-2 mb-3">
        ...
        <h5 className="font-bold text-sm text-ds-feature-dark">Predict the Result / Check Knowledge</h5>
      </div>
  ...
  return (
    <div className="my-6 p-4 rounded-2xl bg-ds-feature-lighter border border-ds-feature-base flex items-center gap-3 shadow-sm" data-improve-block="easy-rule-card">
      ...
      <div>
        ...
        <p className="text-sm font-bold text-ds-text-strong leading-snug mt-0.5">{rule}</p>
      </div>
    </div>
  );
}
