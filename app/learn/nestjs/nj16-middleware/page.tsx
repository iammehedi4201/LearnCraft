 ...
 * CORE CONCEPT
 * ────────────
 * Understand the entry point of the NestJS execution pipeline:
 * NestMiddleware, functional vs class middleware, MiddlewareConsumer,
 * route matching, third-party packages (Helmet, CORS), and correlation IDs.
 *
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 */
...
import { ClassMiddlewareSection } from "./components/class-middleware-section";
import { FunctionalMiddlewareSection } from "./components/functional-middleware-section";
import { MiddlewareConsumerSection } from "./components/middleware-consumer-section";
import { RouteMatchingSection } from "./components/route-matching-section";
import { GlobalMiddlewareSection } from "./components/global-middleware-section";
import { ThirdPartyMiddlewareSection } from "./components/third-party-middleware-section";
import { RequestContextInjectionSection } from "./components/request-context-injection-section";
import { MiddlewareExecutionOrderSection } from "./components/middleware-execution-order-section";
...
const SECTIONS = [
  ...
  { id: "part2",  label: "Class-Based Middleware",      icon: "⚙️" },
  { id: "part3",  label: "Functional Middleware",       icon: "⚡" },
  { id: "part4",  label: "MiddlewareConsumer & Module", icon: "🎛️" },
  { id: "part5",  label: "Route Matching & Filters",    icon: "🎯" },
  { id: "part6",  label: "Global Middleware (app.use)", icon: "🌐" },
  { id: "part7",  label: "Third-Party (Helmet & CORS)", icon: "🛡️" },
  { id: "part8",  label: "Correlation ID & Tracing",    icon: "🏷️" },
  { id: "part9",  label: "Execution Order Rules",       icon: "📐" },
  { id: "part10", label: "Top 5 Beginner Mistakes",     icon: "⚠️" },
  { id: "part11", label: "Top 5 Interview Q&As",        icon: "💡" },
  { id: "part12", label: "5-Pillar Lifecycle Matrix",   icon: "📊" },
  { id: "part13", label: "Middleware Coding Practice",  icon: "💻" },
  { id: "part14", label: "Phase 03 Grand Finale",       icon: "🎓" },
];

const PROGRESS_STORAGE_KEY = "learncraft_progress_nj16-middleware";

export default function NJ16Middleware(): JSX.Element {
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case "part2":  return <ClassMiddlewareSection />;
      case "part3":  return <FunctionalMiddlewareSection />;
      case "part4":  return <MiddlewareConsumerSection />;
      case "part5":  return <RouteMatchingSection />;
      case "part6":  return <GlobalMiddlewareSection />;
      case "part7":  return <ThirdPartyMiddlewareSection />;
      case "part8":  return <RequestContextInjectionSection />;
      case "part9":  return <MiddlewareExecutionOrderSection />;
