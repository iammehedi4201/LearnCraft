...
export default function F06ParallelQueries(): JSX.Element {
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="mt-12">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-6">
            <div className="p-6 bg-white dark:bg-slate-900/50 dark:bg-slate-900/50 rounded-lg border border-gray-200 dark:border-slate-800 dark:border-slate-800">
              <p className="text-sm text-gray-600 mb-2">Overall Status</p>
              <p className="text-2xl font-bold">
                {isLoading ? (
                  <span className="text-blue-600 dark:text-blue-400 dark:text-blue-400">🔄 Loading...</span>
                ) : hasError ? (
          ...
          <div className="space-y-4">
            ...
            <div className="border-2 border-blue-300 rounded-lg overflow-hidden">
              <div className="bg-blue-100 px-4 py-3 border-b border-blue-300">
                <h3 className="font-semibold text-blue-900 dark:text-blue-400 dark:text-blue-400">Query 1: Posts</h3>
              </div>
              <div className="p-4">
                <div className="mb-3">
                ...
                {postsQuery.isLoading ? (
                  <p className="text-blue-600 dark:text-blue-400 dark:text-blue-400">🔄 Fetching posts...</p>
                ) : postsQuery.error ? (
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-700 dark:text-slate-300 dark:text-slate-300 space-y-1">
            ...
            <div className="border-2 border-green-300 rounded-lg overflow-hidden">
              <div className="bg-green-100 px-4 py-3 border-b border-green-300">
                <h3 className="font-semibold text-green-900 dark:text-green-400 dark:text-green-400">Query 2: Users</h3>
              </div>
              <div className="p-4">
                <div className="mb-3">
                  <p className="text-sm font-mono text-gray-600">
  ...
  <div>
    ...
    <h2>{commentsQuery.data.length} comments</h2>
          ...
          <div className="bg-white dark:bg-slate-900/50 dark:bg-slate-900/50 p-6 rounded-lg border border-gray-200 dark:border-slate-800 dark:border-slate-800 mb-6">
            ...
            <p className="text-gray-700 dark:text-slate-300 dark:text-slate-300 text-sm mb-3">
        ...
        <section className="mt-12">
          ...
          <div className="space-y-3">
            <div className="p-4 bg-white dark:bg-slate-900/50 dark:bg-slate-900/50 border-l-4 border-blue-500 rounded">
              <p className="font-semibold text-gray-800 dark:text-slate-200 dark:text-slate-200 mb-2">Parallel (This Feature)</p>
            ...
            <div className="p-4 bg-white dark:bg-slate-900/50 dark:bg-slate-900/50 border-l-4 border-yellow-500 rounded">
              <p className="font-semibold text-gray-800 dark:text-slate-200 dark:text-slate-200 mb-2">Dependent (F-05)</p>
              <p className="text-sm text-gray-700 dark:text-slate-300 dark:text-slate-300">
            ...
            <div className="p-4 bg-white dark:bg-slate-900/50 dark:bg-slate-900/50 border-l-4 border-purple-500 rounded">
              <p className="font-semibold text-gray-800 dark:text-slate-200 dark:text-slate-200 mb-2">Sequential (Anti-pattern)</p>
              <p className="text-sm text-gray-700 dark:text-slate-300 dark:text-slate-300">
